...
const TunlTheme: CustomFlowbiteTheme = {
  ...
  sidebar: {
    ...
    collapse: {
      button:
        'flex items-center text-secondary p-3 rounded-lg transition-all hover:text-primary hover:bg-secondary',
      icon: {
        base: 'w-5 h-5',
        open: {
          on: 'text-secondary',
    ...
    item: {
      ...
      active:
        'flex items-center gap-3 text-primary bg-secondary p-3 rounded-lg transition-all',
    },
  },
}
